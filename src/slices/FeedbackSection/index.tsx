...
function FeedbackSectionSlice({ slice, context }: FeedbackSectionSliceProps) {
      ...
      <div className="flex px-[10px] lg:px-0 lg:flex-row flex-col gap-9">
          ...
          <div className="flex-1">
            <div className="bg-gray-100 dark:bg-gray-600 rounded-xl px-5 py-6 lg:p-8 flex flex-col gap-6 lg:gap-8">
              <div className="dark:text-gray-300">
                <PrismicRichText field={firstTestimonial.comment} />
              </div>
              <div className="flex gap-3 lg:gap-4 items-center">
                {firstTestimonial.person_image && (
                  <PrismicNextImage
                    ...
                    fallbackAlt={firstTestimonial.person_name || "Testimonial author"}
                  />
                )}
                <div className="w-[2px] h-16 bg-border-primary" />
                <div className="flex flex-col">
                  <p className="font-bold">{firstTestimonial.person_name}</p>
                  <p className="text-text-tertiary dark:text-gray-300">{firstTestimonial.person_position}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {secondTestimonial && (
          <div className="flex-1">
            <div className="bg-gray-100 dark:bg-gray-600 rounded-xl px-5 py-6 lg:p-8 flex flex-col gap-6 lg:gap-8">
              <div className="dark:text-gray-300">
                <PrismicRichText field={secondTestimonial.comment} />
              </div>
              <div className="flex flex-row gap-3 lg:gap-4 items-center">
                {secondTestimonial.person_image && (
                  <PrismicNextImage
                    ...
                    fallbackAlt={secondTestimonial.person_name || "Testimonial author"}
                  />
                )}
                <div className="w-[2px] h-16 bg-border-primary" />
                <div className="flex flex-col">
                  <p className="font-bold">{secondTestimonial.person_name}</p>
                  <p className="text-text-tertiary dark:text-gray-300">{secondTestimonial.person_position}</p>
                </div>
              </div>
            </div>
          </div>
